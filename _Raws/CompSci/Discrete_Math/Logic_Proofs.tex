...
All whole numbers and negative of all natural numbers.
...
\dfn{Logically Equivalent}{
	...
	which the domain $U$ is used for the variables in these propositional functions. The notation $S \equiv T$ is used
...
\ex{}{
	...
	\sol{
		...
		\noindent Let $U$ be "students in this class"\\

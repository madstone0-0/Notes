...
segment are loaded into memory.
...
This requires four types of tables:
\begin{description}
...
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{|c c|}
      \hline
      Virtual Memory with Paging & Virtual Memory with Segmentation\\ [0.5ex]
      \hline
      \hline
      Allows internal fragmentation within page frames & Doesn't
      ...
      divided into unequal-sized segments of logically grouped code \\

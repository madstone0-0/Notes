...
\dfn{Universal Set}{
	The set of all objects under consideration, denoted by $\mathbb{U}$. Can be expressed as $\{x  \mid T\} $
}
...
\ex{}{
	...
	\begin{myproof}
		...
		\begin{align*}
			x = \overline{A \cap B}                               \tag*{Assumption}               \\
...
\sol{
	\begin{enumerate}
		\item
		      \begin{align*}
			      A \cup \mathbb{U} & = \{ x  \mid x \in A \cup \mathbb{U}\} \tag*{Set builder notation}        \\
			                        & = \{x  \mid x \in A \vee   x \in \mathbb{U} \} \tag*{Definition of Union} \\
			                        & = \{x  \mid  x \in A \vee  T\} \tag*{Definition of Universal Set}         \\
			                        & = \{x  \mid T \} \tag*{By Domination law for propositional logic}         \\
			                        & = \mathbb{U} \tag*{Definition of Universal Set}                           \\
		      \end{align*}
		\item
		\item
		\item

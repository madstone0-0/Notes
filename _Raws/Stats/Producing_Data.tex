...
\dfn{Cluster Sampling}{
	Used when the population is naturally divided into groups / clusters. A simple random sample of clusters is selected
...
\dfn{Stratified Sampling}{
	Used when the population is naturally divide into sub populations / strata, e.g. gender. A simple random sample is

...
\begin{Verbatim}[commandchars=\\\{\}]
<torch.\_C.Generator at 0x75b5ad14a270>
\end{Verbatim}
\end{tcolorbox}
        
\section{The importance of
Vectorization}\label{the-importance-of-vectorization}
...
\PY{l+s+sa}{f}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+si}{\PYZob{}}\PY{n}{time}\PY{o}{.}\PY{n}{time}\PY{p}{(}\PY{p}{)}\PY{+w}{ }\PY{o}{\PYZhy{}}\PY{+w}{ }\PY{n}{t0}\PY{l+s+si}{:}\PY{l+s+s2}{.5f}\PY{l+s+si}{\PYZcb{}}\PY{l+s+s2}{ sec}\PY{l+s+s2}{\PYZdq{}}
\end{Verbatim}
\end{tcolorbox}

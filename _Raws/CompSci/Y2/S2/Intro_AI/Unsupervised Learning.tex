...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{datasets} \PY{k+kn}{import} \PY{n}{make\PYZus{}swiss\PYZus{}roll}


\PY{k}{def} \PY{n+nf}{set\PYZus{}xyz\PYZus{}axes}\PY{p}{(}\PY{n}{ax}\PY{p}{,} \PY{n}{axes}\PY{p}{)}\PY{p}{:}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{decomposition} \PY{k+kn}{import} \PY{n}{IncrementalPCA}
...
\begin{Verbatim}[commandchars=\\\{\}]
\PY{k}{def} \PY{n+nf}{plotData}\PY{p}{(}\PY{n}{X}\PY{p}{)}\PY{p}{:}
...
\PY{k}{def} \PY{n+nf}{plotCentroids}\PY{p}{(}\PY{n}{centroids}\PY{p}{,} \PY{n}{weights}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{circle\PYZus{}color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{w}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{cross\PYZus{}color}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{k}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{:}
...
\PY{k}{def} \PY{n+nf}{plotDecBounds}\PY{p}{(}
    \PY{n}{clusterer}\PY{p}{,}
    \PY{n}{X}\PY{p}{,}

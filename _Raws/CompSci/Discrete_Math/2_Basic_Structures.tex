...
\sol{
  \begin{enumerate}
    ...
    \item False, as the set $\{0\} $ cannot be a subset of $\O$ as the definition of a subset $\forall x \left( x \in
            \{0\} \to x \in \O \right) $ fails for $0$ as $0$ is not in the empty set.
    \item True, as $\O$ is a subset of any set and $\O \neq \{0\} $
  ...
  \sol{
    \begin{enumerate}
      \item
            \begin{align*}
              A \cap \O & = \{x  \mid x \in A \cap \O\}  \tag*{Set Builder Notation}                 \\
                        & = \{x  \mid x \in A \wedge x \in \O\} \tag*{By Definition of Intersection} \\
                        & = \{x  \mid x \in A \wedge F\} \tag*{By Definition of $\O$}                \\
                        & = \{x  \mid F\} \tag*{By Second Domination Law for propositional logic}    \\

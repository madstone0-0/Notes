...
\dfn{Prescriptive Process Model}{
  Advocates for an orderly approach to software engineering, these models prescribing a set of process elements (framework activities, software engineering actions, tasks, work products, etc.) for each product.
}
